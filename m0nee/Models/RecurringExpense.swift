...
struct RecurringExpense: Identifiable, Codable, Hashable {
	...
	enum CodingKeys: String, CodingKey {
		case id, name, amount, category, details, rating, memo, startDate, recurrenceRule, lastGeneratedDate, excludeFromBudget
	}

	init(id: UUID, name: String, amount: Double, category: String, details: String?, rating: Int?, memo: String?, startDate: Date, recurrenceRule: RecurrenceRule, lastGeneratedDate: Date?, excludeFromBudget: Bool = false) {
		self.id = id
		self.name = name
		self.amount = amount
	...
	init(from decoder: Decoder) throws {
		...
		excludeFromBudget = try container.decodeIfPresent(Bool.self, forKey: .excludeFromBudget) ?? false
	}
	...
	func encode(to encoder: Encoder) throws {
		...
		try container.encode(excludeFromBudget, forKey: .excludeFromBudget)
	}
}
